...
void sub_8E160_sound_proc15_startsequence(__int16 track, unsigned __int8 volume)//26f160
{
	...
	if (x_BYTE_E37FC_music && x_BYTE_E37FD && track <= m_iNumberOfTracks && x_WORD_E3802 != track)
	{
		...
		sub_95C00_AIL_init_sequence(m_hSequence, str_E3808_music_header->str_8.track_10[track].wav_data, 0, track);
...
int sub_A2650(HDIGDRIVER a1)//283650
{
	...
	a1->hw_mode_flags_7 = *(x_WORD*)(14 * a1->hw_mode_flags_7 + (uint8_t*)&a1->DDT_1 + 28);
...
char LoadMusicTrack(FILE* filehandle, uint8_t drivernumber)//26fd00
{
	...
	//shadow_type_E3808_music_header* shadow_str_E3808_music_header = (shadow_type_E3808_music_header*)sub_83CD0_malloc2(headerx[drivernumber].sizeBytes_8 + 32);
	...
	*/
	...
	for (int i = 0; i < 6; i++)
	{
		str_E3808_music_header->str_8.track_10[i].wav_data = (uint8_t*)shadow_str_E3808_music_header->str_8.track_10[i].dword_0;
		for (int j = 0; j < 4; j++)
			str_E3808_music_header->str_8.track_10[i].stub_4[j] = shadow_str_E3808_music_header->str_8.track_10[i].stub_4[j];
		str_E3808_music_header->str_8.track_10[i].wav_size = shadow_str_E3808_music_header->str_8.track_10[i].dword_8;
	...
	for (i = 1; i <= m_iNumberOfTracks; i++)//2b4804 - 6
		sub_95C00_AIL_init_sequence(m_hSequence, str_E3808_music_header->str_8.track_10[i].wav_data, 0, i);
