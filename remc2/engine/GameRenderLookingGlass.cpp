#include "GameRenderLookingGlass.h"

GameRenderLookingGlass::GameRenderLookingGlass(uint8_t* ptrScreenBuffer, uint8_t* pColorPalette, uint16_t screenWidth, uint16_t screenHeight, uint8_t cols, uint8_t rows, uint8_t renderThreads, bool assignToSpecificCores) :
	m_ptrScreenBuffer_351628(ptrScreenBuffer), m_ptrColorPalette(pColorPalette), m_uiScreenWidth_18062C(screenWidth), m_uiScreenHeight_180624(screenHeight), m_uiCols(cols), m_uiRows(rows),
	m_assignToSpecificCores(assignToSpecificCores)
{
	SetRenderThreads(renderThreads);
}

GameRenderLookingGlass::~GameRenderLookingGlass()
{
...
void GameRenderLookingGlass::DrawWorld_411A0(int posX, int posY, int16_t yaw, int16_t posZ, int16_t pitch, int16_t roll, int16_t fov)
{
	...
	if (m_uiScreenWidth_18062C > 320 && m_uiScreenHeight_180624 > 200) {
		...
		for (int y = (m_uiRows - 1); y >= 0; y--)
		{
			for (int x = 0; x < m_uiCols; x++)
			{
				...
				int taskPosX = vPosX + transX;
				int taskPosY = vPosY + transY;
				SDL_Rect taskViewPort;
				taskViewPort.x = x * viewPortWidth;
...
*/
void GameRenderLookingGlass::DrawSky_40950(int16_t roll, RenderViewPort viewPort, type_F2C20ar str_F2C20ar)
{
	int skyTextSize = 256;
	...
	uint8_t* viewPortRenderBufferStart = viewPort.m_ptrScreenBufferStart;
	...
	if (viewPort.Height_DE568)
	{
		...
		{
			index = 0;
			uint8_t* viewPortLineRenderBufferStart = viewPort.m_ptrScreenBufferStart;
			...
			viewPortRenderBufferStart = viewPortRenderBufferStart + viewPort.m_iScreenWidth;
...
void GameRenderLookingGlass::DrawTerrainAndParticles_3C080(__int16 posX, __int16 posY, __int16 yaw, signed int posZ, int pitch, int16_t roll, int fov, RenderViewPort viewPort, RenderParametersType* renderParameters)
{
	...
	SetBillboards_3B560(-roll & 0x7FF, viewPort, str_F2C20ar);//21d1aa
	...
	if (!D41A0_0.m_GameSettings.m_Graphics.m_wSky || isCaveLevel_D41B6)
	{
		...
		v27 = viewPort.m_iScreenWidth - viewPort.Width_DE564;
		v28 = (v26 - (__CFSHL__((signed int)v26 >> 31, 2) + 4 * ((signed int)v26 >> 31))) >> 2;
		v29 = viewPort.Height_DE568;
		v25x = viewPort.m_ptrScreenBufferStart;
	...
	{
		DrawSky_40950(roll, viewPort, str_F2C20ar);
	}
	//Cave Level Render
...
void GameRenderLookingGlass::sub_88740(type_event_0x6E8E* a1x, int a2, int a3)
{
	int v3; // esi
...
void GameRenderLookingGlass::SetBillboards_3B560(int16_t roll, RenderViewPort viewPort, type_F2C20ar str_F2C20ar)
{
	int v1; // edx
...
void GameRenderLookingGlass::DrawSorcererNameAndHealthBar_2CB30(type_event_0x6E8E* a1x, __int16 a2, int a3, __int16 a4, RenderViewPort viewPort)
{
	char* v5; // esi
	int v9x; // eax
	int v9y; // eax
	...
	v31 = viewPort.PosX_EA3D0 - 4;
	v29 = viewPort.PosY_EA3CC - 22;
...
void GameRenderLookingGlass::StartWorkerThreads(uint8_t numOfThreads, bool assignToSpecificCores)
{
...
void GameRenderLookingGlass::StartWorkerThread()
{
...
void GameRenderLookingGlass::StartWorkerThread(int core)
{
...
void GameRenderLookingGlass::StopWorkerThreads()
{
	if (m_renderThreads.size() > 0)
	{
...
void GameRenderLookingGlass::DrawSprite_41BD3(uint32 a1, RenderViewPort viewPort, RenderParametersType* renderParameters, type_F2C20ar str_F2C20ar)
{
			...
			LABEL_126:
				if ((unsigned int)str_F2C20ar.dword0x1e <= 7)
				{
					...
					case 0:
						...
						LABEL_136:
							v123 = viewPort.m_iScreenWidth * v170 + viewPort.m_ptrScreenBufferStart;
							goto LABEL_137;
						}
						break;
					case 1:
						...
						else
						{
							...
							LABEL_284:
								v123 = v171 + viewPort.m_ptrScreenBufferStart;
								goto LABEL_285;
							}
						}
						break;
					case 2:
						...
						v170 = str_F2C20ar.dword0x21;
					LABEL_329:
						v123 = str_F2C20ar.width0x25 + viewPort.m_ptrScreenBufferStart - 1 - v170;
						goto LABEL_137;
					case 3:
						v156 = str_F2C20ar.dword0x27 * str_F2C20ar.dword0x09_realWidth >> 16;
						if (v156 <= 0)
						...
						v123 = str_F2C20ar.height0x26 + viewPort.m_iScreenWidth * v171 - 1 + viewPort.m_ptrScreenBufferStart;
						goto LABEL_285;
					case 4:
						v156 = str_F2C20ar.dword0x1b * str_F2C20ar.dword0x09_realWidth >> 16;
						if (v156 <= 0)
						...
						v170 = str_F2C20ar.dword0x21;
					LABEL_348:
						v123 = str_F2C20ar.height0x26 + viewPort.m_ptrScreenBufferStart + viewPort.m_iScreenWidth * (str_F2C20ar.width0x25 - v170 - 1) - 1;
						goto LABEL_137;
					case 5:
						v156 = str_F2C20ar.dword0x27 * str_F2C20ar.dword0x09_realWidth >> 16;
						if (v156 <= 0)
						...
						v123 = (str_F2C20ar.height0x26 - 1) * viewPort.m_iScreenWidth + str_F2C20ar.width0x25 + viewPort.m_ptrScreenBufferStart - 1 - v171;
						goto LABEL_285;
					case 6:
						v156 = str_F2C20ar.dword0x1b * str_F2C20ar.dword0x09_realWidth >> 16;
						if (v156 <= 0)
						...
						v170 = str_F2C20ar.dword0x21;
					LABEL_367:
						v123 = viewPort.m_ptrScreenBufferStart + viewPort.m_iScreenWidth * (str_F2C20ar.height0x26 - 1) + v170;
					LABEL_137:
					...
					case 7:
						...
						v123 = viewPort.m_iScreenWidth * (str_F2C20ar.width0x25 - 1 - v171) + viewPort.m_ptrScreenBufferStart;
					LABEL_285:
				...
				if (a1 == 1)
				{
					...
					{
						DrawSorcererNameAndHealthBar_2CB30(str_F2C20ar.dword0x14x, str_F2C20ar.dword0x04_screenY, (signed __int16)str_F2C20ar.dword0x03_screenX, str_F2C20ar.dword0x09_realWidth, viewPort);
					}
	...
	if ((unsigned __int16)viewPort.Width_DE564 > str_F2C20ar.dword0x04_screenY)
	{
		...
		if ((unsigned __int16)viewPort.Height_DE568 > str_F2C20ar.dword0x03_screenX)
		{
			...
			//               screen-Y                                            screen-X
			v122x = &viewPort.m_ptrScreenBufferStart[str_F2C20ar.dword0x03_screenX * viewPort.m_iScreenWidth + str_F2C20ar.dword0x04_screenY];
			//height
			...
			LABEL_24:
				...
				if (v9 >= 0)
				{
					if (v9 >= viewPort.Height_DE568)
						return;
					v1102 = viewPort.m_ptrScreenBufferAltStart + viewPort.m_iScreenWidth * v9;
					v1292 = 0;
				}
				else
				{
					v1102 = viewPort.m_ptrScreenBufferAltStart;
					v1292 = 1;
				}
				v10 = v5->Y;
		...
		LABEL_234:
			...
			if (v117 >= 0)
			{
				if (v117 >= viewPort.Height_DE568)
					return;
				v1102 = viewPort.m_ptrScreenBufferAltStart + viewPort.m_iScreenWidth * v117;
				v1294 = 0;
			}
			else
			{
	...
	LABEL_277:
		...
		if (v143 >= 0)
		{
			if (v143 >= viewPort.Height_DE568)
				return;
			v1102 = viewPort.m_ptrScreenBufferAltStart + viewPort.m_iScreenWidth * v143;
			v1295 = 0;
		}
		else
		{
...
LABEL_129:
	...
	if (v65 >= 0)
	{
		if (v65 >= viewPort.Height_DE568)
			return;
		v1102 = viewPort.m_ptrScreenBufferAltStart + viewPort.m_iScreenWidth * v65;
		v1293 = 0;
	}
	else
	{
				...
				LABEL_53:
					...
					case 1:
						...
						while (1)
						{
							LOWORD(v31) = v175[1];
							v176 = v175[3];
							v177 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line2++;
					...
					case 2:
						...
						while (1)
						{
							LOWORD(v228) = v227[1];
							v230 = v227[3];
							v231 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line3++;
					...
					case 3:
						...
						while (1)
						{
							LOWORD(v284) = v283[1];
							v286 = v283[3];
							v287 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line4++;
					...
					case 4:
						...
						while (1)
						{
							LOWORD(v31) = v339[1];
							v340 = v339[3];
							v341 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line5++;
					...
					case 5:
						...
						while (1)
						{
							...
							v379 = viewPort.m_iScreenWidth + v1102;
							v1102 += viewPort.m_iScreenWidth;
							line6++;
					...
					case 6:
						...
						while (1)
						{
							...
							v394 = viewPort.m_iScreenWidth + v1102;
							v1102 += viewPort.m_iScreenWidth;
							line7++;
					...
					case 0xB:
						...
						while (1)
						{
							LOWORD(v406) = v405[1];
							v408 = v405[3];
							v409 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line8++;
					...
					case 8:
						...
						while (1)
						{
							LOWORD(v446) = v445[1];
							v448 = v445[3];
							v449 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line9++;
					...
					case 0xA:
						...
						while (1)
						{
							LOWORD(v486) = v485[1];
							v488 = v485[3];
							v489 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line10++;
					...
					case 0xC:
						...
						while (1)
						{
							LOWORD(v526) = v525[1];
							v528 = v525[3];
							v529 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line11++;
					...
					case 0xD:
						...
						while (1)
						{
							LOWORD(v566) = v565[1];
							v568 = v565[3];
							v569 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line12++;
					...
					case 0x10:
						...
						while (1)
						{
							LOWORD(v31) = v647[1];
							v649 = v647[3];
							v650 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line15++;
					...
					case 0x11:
						...
						while (1)
						{
							LOWORD(v31) = v684[1];
							v686 = v684[3];
							v687 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line16++;
					...
					case 0x12:
						...
						while (1)
						{
							LOWORD(v722) = v721[1];
							v724 = v721[3];
							v725 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line17++;
					...
					case 0x13:
						...
						while (1)
						{
							LOWORD(v762) = v761[1];
							v764 = v761[3];
							v765 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line18++;
					...
					case 0x14:
						...
						while (1)
						{
							LOWORD(v802) = v801[1];
							v804 = v801[3];
							v805 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line19++;
					...
					case 0x15:
						...
						while (1)
						{
							LOWORD(v843) = v842[1];
							v845 = v842[3];
							v846 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line20++;
					...
					case 0x16:
						...
						while (1)
						{
							LOWORD(v884) = v883[1];
							v886 = v883[3];
							v887 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line21++;
					...
					case 0x17:
						...
						while (1)
						{
							LOWORD(v924) = v923[1];
							v926 = v923[3];
							v927 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line22++;
					...
					case 0x18:
						...
						while (1)
						{
							LOWORD(v964) = v963[1];
							v966 = v963[3];
							v967 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line23++;
					...
					case 0x19:
						...
						while (1)
						{
							...
							v1007 = v1004[3];
							v1008 = (x_BYTE*)(viewPort.m_iScreenWidth + v1102);
							v1102 += viewPort.m_iScreenWidth;
							line24++;
					...
					while (1)
					{
						...
						v1048 = v1045[3];
						v1049 = (char*)(viewPort.m_iScreenWidth + v1102);
						v1102 += viewPort.m_iScreenWidth;
						line25++;
...
x_DWORD* GameRenderLookingGlass::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int s0, int s1, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRenderLookingGlass::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v4, int s0, int s1, int s4, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRenderLookingGlass::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v2, int* v3, int s0, int s1, int s2, int s3, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
x_DWORD* GameRenderLookingGlass::LoadPolygon(x_DWORD* ptrPolys, int* v0, int* v1, int* v2, int* v3, int* v4, int s0, int s1, int s2, int s3, int s4, int* line)
{
	do
	{
		ptrPolys[0] = *v0;
...
void GameRenderLookingGlass::SetRenderThreads(uint8_t renderThreads)
{
	StopWorkerThreads();
...
uint8_t GameRenderLookingGlass::GetRenderThreads()
{
	return m_renderThreads.size();
}

void GameRenderLookingGlass::WaitForRenderFinish()
{
	int taskCount = 0;
