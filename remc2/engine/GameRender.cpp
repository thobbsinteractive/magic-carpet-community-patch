					...
					for (jx = v57x; ; jx = (v80x + 1))
					{
						...
						if ((v66 & v65 & 0x80u) == 0)
						{
							...
							if (!(v67 & 2))
							{
								...
								if (!(v69 & 0xF00))
								{
									DrawInverseSquareInProjectionSpace(v248x, v68x, m_textureAddresses[1], viewPort.Width_DE564, viewPort.Height_DE568, screenWidth);
								}
							}
						}
						...
						do
						{
							...
							if ((v92 & v89 & 0x80u) == 0)
							{
								...
								if (!(v93 & 2))
								{
									...
									DrawInverseSquareInProjectionSpace(v248x, v94x, m_textureAddresses[1], viewPort.Width_DE564, viewPort.Height_DE568, screenWidth);
								}
							}
						...
						for (n = 39; n; --n)
						{
							...
							if (m_Str_E9C38_smalltit[v143x].byte41)
							{
								...
								if (!(v144 & 2))
								{
									...
									if (!(v145 & 0xF00))
									{
										DrawInverseSquareInProjectionSpace(v248x, v143x, viewPort.Width_DE564, viewPort.Height_DE568, screenWidth);
									}
								}
							}
							...
							do
							{
								...
								if (m_Str_E9C38_smalltit[v155x].byte41)
								{
									...
									if (!(v156 & 2))
									{
										...
										if (!(v157 & 0xF00))
										{
											DrawInverseSquareInProjectionSpace(v248x, v155x, viewPort.Width_DE564, viewPort.Height_DE568, screenWidth);
										}
									}
								}
